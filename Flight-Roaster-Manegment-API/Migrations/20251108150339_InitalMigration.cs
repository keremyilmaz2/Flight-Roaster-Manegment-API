        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MinCrewRequired = table.Column<int>(type: "int", nullable: false),
                    MaxCrewCapacity = table.Column<int>(type: "int", nullable: false),
                    MinCabinCrewRequired = table.Column<int>(type: "int", nullable: false),
                    MaxCabinCrewCapacity = table.Column<int>(type: "int", nullable: false),
                    MaxRangeKm = table.Column<decimal>(type: "decimal(10,2)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CodeShareFlightNumber = table.Column<string>(type: "nvarchar(10)", maxLength: 10, nullable: true),
                    CodeShareAirline = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    IsActive = table.Column<bool>(type: "bit", nullable: false)
                },
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    QualifiedAircraftTypes = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: false),
                    Recipes = table.Column<string>(type: "nvarchar(1000)", maxLength: 1000, nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CabinCrews", x => x.CabinCrewId);
                    table.ForeignKey(
                        name: "FK_CabinCrews_Users_UserId",
                        column: x => x.UserId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Seniority = table.Column<int>(type: "int", nullable: false),
                    MaxFlightDistanceKm = table.Column<decimal>(type: "decimal(10,2)", nullable: false),
                    QualifiedAircraftTypes = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: false),
            ...
            migrationBuilder.CreateTable(
                name: "FlightCabinCrews",
                columns: table => new
                {
                    FlightCabinCrewId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    FlightId = table.Column<int>(type: "int", nullable: false),
                    CabinCrewId = table.Column<int>(type: "int", nullable: false),
                    AssignedRecipe = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: true),
                    AssignedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    IsActive = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_FlightCabinCrews", x => x.FlightCabinCrewId);
                    table.ForeignKey(
                        name: "FK_FlightCabinCrews_CabinCrews_CabinCrewId",
                        column: x => x.CabinCrewId,
                        principalTable: "CabinCrews",
                        principalColumn: "CabinCrewId",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_FlightCabinCrews_Flights_FlightId",
                        column: x => x.FlightId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsInfantSeat = table.Column<bool>(type: "bit", nullable: false),
                    ParentPassengerId = table.Column<int>(type: "int", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Seats_Passengers_ParentPassengerId",
                        column: x => x.ParentPassengerId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    FlightCrewId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    FlightId = table.Column<int>(type: "int", nullable: false),
                    PilotId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_FlightCrews", x => x.FlightCrewId);
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_FlightCrews_Pilots_PilotId",
                        column: x => x.PilotId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CabinCrews_UserId",
                table: "CabinCrews",
                column: "UserId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_FlightCabinCrews_CabinCrewId",
                table: "FlightCabinCrews",
                column: "CabinCrewId");

            migrationBuilder.CreateIndex(
                name: "IX_FlightCabinCrews_FlightId",
                table: "FlightCabinCrews",
                column: "FlightId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Seats_ParentPassengerId",
                table: "Seats",
                column: "ParentPassengerId");
